...
describe Homework3 do
  ...
  describe '#task2' do
    ...
    context 'calls methods and return corrent formated array' do
      ...
      it 'calls #true_strs then #result' do
        expect(subject).to receive(:true_strs).ordered
        expect(subject).to receive(:result).ordered
    ...
    context 'no suitable string at the input' do
