...
require_relative "#{File.dirname(__FILE__)}/../anastasia_evsihneyeva_hw_03_t_01"
...
RSpec.describe Homework3 do
  ...
  context 'when all strings contain \'error\' word' do
    it 'returns first string' do
      expect(subject { described_class.configuration }.task1("2018-04-23 20:30:42: SSL error, peer: 10.6.246.101, peer cert: , #<Puma::MiniSSL::SSLError: System error: Undefined error: 0 - 0>
